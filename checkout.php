				...
				if(!preg_match("/^[0-9 -]*$/", $ic)){
					...
					if (empty($_POST["email"])){
						...
						if (filter_var($email, FILTER_VALIDATE_EMAIL)){
							$emailErr = "Invalid email foRS. at";
							$email = "";
						}else{
							$email = $_POST['email'];
...
if(!isset($_SESSION['id'])){
	...
	echo 'Adhar Number:<br><input type="text" name="ic" placeholder="xxxxxx-xx-xxxx">';
	...
	echo 'Mobile Number:<br><input type="text" name="contact" placeholder="">';
